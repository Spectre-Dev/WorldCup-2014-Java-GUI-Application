 ...
 * @author x13399691
 */
public class AGroupTable extends javax.swing.JFrame {

    /**
     * Creates new form GroupTables
     */
    public AGroupTable() {
        initComponents();
    ...
    private void initComponents() {
        ...
        groupBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teams/pictures/Back Button_2.png"))); // NOI18N
        ...
        backgroundLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teams/pictures/BackgroundGA.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AGroupTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new AGroupTable().setVisible(true);
            }
        });
    }
