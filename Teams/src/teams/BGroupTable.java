 ...
 * @author x13399691
 */
public class BGroupTable extends javax.swing.JFrame {

    /**
     * Creates new form BGroupTable
     */
    public BGroupTable() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        backgroundLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teams/pictures/BackgroundGB.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BGroupTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BGroupTable().setVisible(true);
            }
        });
    }
