 ...
 * @author x13399691
 */
public class CGroupTable extends javax.swing.JFrame {

    /**
     * Creates new form CGroupTable
     */
    public CGroupTable() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        backgroundLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teams/pictures/BackgroundGC.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CGroupTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CGroupTable().setVisible(true);
            }
        });
    }
