 ...
 * @author x13399691
 */
public class DGroupTable extends javax.swing.JFrame {

    /**
     * Creates new form DGroupTable
     */
    public DGroupTable() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        backgroundLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teams/pictures/BackgroundGD.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DGroupTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DGroupTable().setVisible(true);
            }
        });
    }
