 ...
 * @author x13399691
 */
public class EGroupTable extends javax.swing.JFrame {

    /**
     * Creates new form EGroupTable
     */
    public EGroupTable() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        backgroundLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teams/pictures/BackgroundGE.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EGroupTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EGroupTable().setVisible(true);
            }
        });
    }
