 ...
 * @author x13399691
 */
public class GGroupTable extends javax.swing.JFrame {

    /**
     * Creates new form GGroupTable
     */
    public GGroupTable() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        backgroundLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teams/pictures/BackgroundGG.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GGroupTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GGroupTable().setVisible(true);
            }
        });
    }
